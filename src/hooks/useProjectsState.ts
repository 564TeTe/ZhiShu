...
import { IS_TASK_CENTER_ENABLED, IS_TASK_CENTER_PRIMARY } from '../constants/config';
import { api } from '../utils/api';
import { resolveInitialTab } from '../utils/taskCenterDefaultTab';
...
const readPersistedTab = (): AppTab => resolveInitialTab(localStorage, {
  taskCenterEnabled: IS_TASK_CENTER_ENABLED,
  taskCenterPrimary: IS_TASK_CENTER_PRIMARY,
});
