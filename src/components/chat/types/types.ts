...
export interface ChatMessage {
  ...
  /** Vision processing: client-side dedup key. */
  _clientMessageId?: string;
  /** Vision processing: current status. */
  _visionStatus?: 'analyzing' | 'analyzed' | 'analysis_failed';
  /** Vision processing: display metadata (description, errorText, etc.). */
  _visionResult?: Record<string, unknown>;
  /** Vision processing: error message when analysis fails. */
  _visionError?: string;
  [key: string]: unknown;
}
