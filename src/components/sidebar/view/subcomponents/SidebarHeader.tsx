...
export default function SidebarHeader({
  ...
  const LogoBlock = () => (
    <div className="flex min-w-0 items-center">
      <img
        ...
        alt={t('app.title')}
        className="h-8 w-auto max-w-[104px] flex-shrink-0 object-contain"
      />
    </div>
  );
  ...
  return (
    <div className="flex-shrink-0">
      {/* Desktop header */}
      <div
        className="hidden px-3 pb-1.5 pt-2 md:block"
        style={{}}
      >
          ...
          <div className="mt-2 space-y-1.5">
            ...
            <div className="flex rounded-md bg-muted/50 p-0.5">
              <button
                ...
                className={cn(
                  "flex-1 flex items-center justify-center gap-1 rounded-sm px-1.5 py-1 text-[11px] font-normal transition-all",
                  searchMode === 'projects'
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="nav-search-input h-8 rounded-lg border-0 pl-8 pr-12 text-[13px] transition-all duration-200 placeholder:text-muted-foreground/40 focus-visible:ring-0 focus-visible:ring-offset-0"
              />
              {searchFilter ? (
                <button
          ...
          <div className="mt-2.5 space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                value={searchFilter}
                onChange={(event) => onSearchFilterChange(event.target.value)}
                className="nav-search-input h-9 rounded-lg border-0 pl-9 pr-9 text-[13px] transition-all duration-200 placeholder:text-muted-foreground/40 focus-visible:ring-0 focus-visible:ring-offset-0"
              />
              {searchFilter && (
                <button
                  onClick={onClearSearchFilter}
