        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                <div className="min-w-0 flex-1 truncate text-[13px] font-medium leading-tight text-foreground">{sessionView.sessionName}</div>
                {isProcessing ? (
      ...
      <div className="hidden md:block">
        <a
          ...
          className={cn(
            ...
            'h-auto w-full justify-start rounded-sm px-2 py-1 pr-8 text-left font-normal leading-tight transition-colors',
            isSelected ? 'bg-indigo-50/60' : 'hover:bg-slate-50',
            !isSelected && isProcessing ? 'bg-slate-50/50' : '',
            !isSelected && sessionView.isActive && !isProcessing ? 'bg-slate-50/30' : '',
          )}
