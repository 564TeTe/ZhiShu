...
export default function SidebarContent({
  ...
  return (
    <div
      className="app-sidebar-surface flex h-full w-full min-w-0 flex-col bg-background/80 backdrop-blur-sm md:select-none"
      style={{}}
    >
      <SidebarHeader
        isPWA={isPWA}
      ...
      <ScrollArea className="scrollbar-thin min-w-0 flex-1 overflow-y-auto overscroll-contain md:px-1 md:py-1.5">
