...
export const SETTINGS_MAIN_TABS: SettingsMainTabMeta[] = [
  ...
  { id: 'vision', label: 'Vision', keywords: 'vision image picture screenshot analysis', icon: Image },
  { id: 'connections', label: 'Model Connections', keywords: 'claude model api base url gateway deepseek connection', icon: Plug },
