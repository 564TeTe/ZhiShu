import { Bell, Bot, GitBranch, Image, Info, Key, ListChecks, Mic, MonitorPlay, Palette, Plug, Puzzle } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'vision', labelKey: 'mainTabs.vision', icon: Image },
  { id: 'connections', labelKey: 'mainTabs.connections', icon: Plug },
