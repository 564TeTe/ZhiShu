...
import VisionSettingsTab from '../view/tabs/VisionSettingsTab';
import RuntimeConnectionsSettingsTab from '../view/tabs/RuntimeConnectionsSettingsTab';
            ...
            <div key={activeTab} className="settings-content-enter min-w-0 space-y-6 overflow-x-hidden p-4 pb-safe-area-inset-bottom md:space-y-8 md:p-6">
              {activeTab === 'appearance' && (
                <AppearanceSettingsTab
                  ...
                  onWallpaperSettingsChange={handleWallpaperSettingsChange}
                />
              )}
              ...
              {activeTab === 'connections' && <RuntimeConnectionsSettingsTab />}
