...
import { IS_TASK_CENTER_ENABLED } from '../../../constants/config';
...
import { AgentTaskCenter } from '../../agent-tasks';
...
function MainContent({
  ...
  const shouldShowTaskCenterTab = IS_TASK_CENTER_ENABLED;
  ...
  useEffect(() => {
    if (!shouldShowTaskCenterTab && activeTab === 'task-center') {
      setActiveTab('chat');
    }
  }, [shouldShowTaskCenterTab, activeTab, setActiveTab]);
  ...
  return (
    <div className="flex h-full flex-col">
      <MainContentHeader
        ...
        shouldShowTaskCenterTab={shouldShowTaskCenterTab}
      ...
      <div className="flex min-h-0 flex-1 overflow-hidden">
        <div className={`flex min-h-0 min-w-[200px] flex-col overflow-hidden ${editorExpanded ? 'hidden' : ''} flex-1`}>
          ...
          {shouldShowTaskCenterTab && activeTab === 'task-center' && (
            <TaskCenter project={selectedProject} />
          )}

          {activeTab === 'agent-tasks' && <AgentTaskCenter project={selectedProject} />}
