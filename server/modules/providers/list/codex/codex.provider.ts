...
import { codexControlledRuntime } from '@/modules/providers/list/codex/codex-controlled-runtime.provider.js';
...
export class CodexProvider extends AbstractProvider {
  readonly runtime: IProviderRuntime = codexControlledRuntime;
